...
setwd("C:/Users/gohil/Desktop/GOAL/FINGERTIPS/6. R/PROJECTS/Hypothesis Automtion")
...
HypothesisAutomation(data$Total.Revenue,data$Total.Profit,col1_name,col2_name)
